...
export class CarouselComponent {
  ...
  galleryData = [
    { alt: 'Image 1', url: 'assets/white_black.svg', width: 600, height: 400 },
    { alt: 'Image 2', url: 'assets/red_white.svg', width: 600, height: 400 },
    { alt: 'Image 3', url: 'assets/white_yellow.svg', width: 600, height: 400 },
  ];
